...
namespace WooCommerceDonationManager\ByteKit\Traits;
...
trait HasPlugin {
	...
	public function get_plugin_meta_links() {
		...
		if ( ! empty( $this->get_docs_url() ) ) {
			$links['docs'] = array(
				'label' => __( 'Documentation', 'wc-donation-manager' ),
		...
		if ( ! empty( $this->get_support_url() ) ) {
			$links['support'] = array(
				'label' => __( 'Support', 'wc-donation-manager' ),
		...
		if ( ! empty( $this->get_review_url() ) ) {
			$links['review'] = array(
				'label' => __( 'Review', 'wc-donation-manager' ),
	...
	public function get_plugin_action_links() {
		...
		if ( ! empty( $this->get_settings_url() ) ) {
			$links['settings'] = array(
				'label' => __( 'Settings', 'wc-donation-manager' ),
